<!--
	Young Carpets V10 — "Come Alive"
	Scroll-activated alive effects with premium glow transitions.
	Built on V9 structure with IntersectionObserver-driven section awakening.
	2026-04-09
-->
<script lang="ts">
	...
	function v10ScrollTo(id: string) {
...
<div class="yc-page v10" bind:this={pageEl}>
	{#if dev}
		<div class="yc-dev-version-badge" aria-hidden="true">v{ycVersion} · V10</div>
	{/if}

	<!-- Scroll progress indicator -->
	<div class="v10-progress" style="transform: scaleX({scrollProgress})" aria-hidden="true"></div>
	...
	<!-- Navbar -->
	<nav class="v10-nav">
		<div class="v10-nav-left">
			<a href="/young-carpets/dev/v10" class="v10-nav-brand">YOUNG</a>
			{#if activeSection && sectionMap[activeSection]}
				<span class="v10-nav-section">{sectionMap[activeSection]}</span>
			{/if}
		</div>
		<div class="v10-nav-right">
			<ThemeToggle />
			<button
				class="v10-hamburger"
			...
			>
				<span class="v10-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v10-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v10-hamburger-bar" class:open={mobileMenuOpen}></span>
			</button>
		</div>
		{#if mobileMenuOpen}
			<div class="v10-mobile-menu">
				<button onclick={() => v10ScrollTo('products')}>Products</button>
				<button onclick={() => v10ScrollTo('what')}>Services</button>
				<button onclick={() => v10ScrollTo('contact')}>Contact</button>
			</div>
		{/if}
	</nav>
	...
	<section class="yc-hero" class:alive={heroAlive}>
		<div class="yc-container">
			<div class="v10-hero-maple" aria-label="Proudly Canadian">
			...
			<p class="v10-hero-tag">Commercial Flooring &middot; Ottawa, Ontario</p>
			<h1 class="v10-wordmark" class:v10-wordmark--ready={wordmarkReady} aria-label="Young">
				{#each LETTERS as ch, i (ch + i)}
					<span
						class="v10-wordmark__char"
						style="--young-i: {i};"
						aria-hidden="true"
					>{ch}</span>
				{/each}
			</h1>
			<p class="v10-hero-sub">
				Supply, installation, and maintenance &mdash; for offices, institutions, and retail.
			</p>
			<div class="v10-hero-actions">
				<button class="v10-cta-primary" onclick={() => v10ScrollTo('products')}>
					View Products
				</button>
				<a href="tel:613-744-2744" class="v10-cta-secondary">
					Call Us
				</a>
			</div>
			<div class="v10-hero-stats">
				<div class="v10-stat">
					<span class="v10-stat-number" use:countUp data-target="250" data-suffix="+">0</span>
					<span class="v10-stat-label">combined years</span>
				</div>
				<div class="v10-stat">
					<span class="v10-stat-number" use:countUp data-target="50000" data-suffix="+">0</span>
					<span class="v10-stat-label">jobs completed</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contact" class="yc-section yc-section--contact" use:reveal>
		<div class="yc-container">
			...
			<div class="v10-contact-grid">
				...
				<div class="v10-contact-side">
					<div class="v10-contact-card">
						<h3>Accounting</h3>
						<div class="v10-person-card">
	...
	{#if openProduct}
		...
		<div class="v10-modal-backdrop" onclick={closeProduct}>
			<!-- svelte-ignore a11y_no_static_element_interactions -->
			<div class="v10-modal" onclick={(e) => e.stopPropagation()}>
				<button class="v10-modal-close" onclick={closeProduct} aria-label="Close">
				...
				<div class="v10-modal-header">
					<span class="v10-modal-code">{openProduct.code}</span>
					{#if openProduct.nameHtml}
						<h2 class="v10-modal-title">{@html openProduct.nameHtml}</h2>
					{:else}
						<h2 class="v10-modal-title">{openProduct.name}</h2>
					{/if}
				</div>

				<!-- Tab buttons -->
				<div class="v10-modal-tabs">
					<button
						class="v10-tab-btn"
						class:v10-tab-btn--active={activeTab === 'product'}
						onclick={() => switchTab('product')}
					>Product</button>
					<button
						class="v10-tab-btn"
						class:v10-tab-btn--active={activeTab === 'install'}
						onclick={() => switchTab('install')}
					>Install</button>
					<button
						class="v10-tab-btn"
						class:v10-tab-btn--active={activeTab === 'maintenance'}
				...
				<div class="v10-modal-body">
					{#key tabAnimKey}
						{#if activeTab === 'product'}
							...
							<div class="v10-tab-content v10-tab-enter">
								<div class="v10-cross-section">
									<div class="v10-cs-title-row">
										...
										<span class="v10-cs-label">Cross-Section</span>
									</div>
									<div class="v10-cs-diagram">
										{#each layers as layer, li}
											<div
												...
												"
											>
												<div class="v10-cs-layer-fill"></div>
												<span class="v10-cs-layer-label">{layer.label}</span>
												<div class="v10-cs-dim-line">
													<span class="v10-cs-dim-cap"></span>
													<span class="v10-cs-dim-stem"></span>
													<span class="v10-cs-dim-cap"></span>
												</div>
											</div>
										{/each}
						...
						{:else if activeTab === 'install'}
							<!-- == INSTALL TAB == -->
							<div class="v10-tab-content v10-tab-enter">
								<div class="v10-install-visual">
									<div class="v10-install-icon">
										{#if mat === 'carpet-tile'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1.2" fill="none">
													<rect x="10" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v10-install-tile v10-it-1"/>
													<rect x="55" y="10" width="40" height="40" rx="2" fill="#444446" class="v10-install-tile v10-it-2"/>
													<rect x="100" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v10-install-tile v10-it-3"/>
													<rect x="145" y="10" width="40" height="40" rx="2" fill="#444446" class="v10-install-tile v10-it-4"/>
													<rect x="10" y="55" width="40" height="40" rx="2" fill="#444446" class="v10-install-tile v10-it-5"/>
													<rect x="55" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v10-install-tile v10-it-6"/>
													<rect x="100" y="55" width="40" height="40" rx="2" fill="#444446" class="v10-install-tile v10-it-7"/>
													<rect x="145" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v10-install-tile v10-it-8"/>
													<rect x="10" y="100" width="40" height="40" rx="2" fill="#3a3a3c" class="v10-install-tile v10-it-9" opacity="0.4" stroke-dasharray="3 2"/>
												</g>
												<path d="M30 135 L30 115" stroke="#d4b87a" stroke-width="1.5" fill="none" marker-end="url(#v10arr)"/>
												<defs><marker id="v10arr" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#d4b87a"/></marker></defs>
											</svg>
										{:else if mat === 'lvt'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													<rect x="10" y="20" width="85" height="26" rx="2" fill="#3e3e40" class="v10-install-plank v10-ip-1"/>
													<rect x="100" y="20" width="85" height="26" rx="2" fill="#444446" class="v10-install-plank v10-ip-2"/>
													<rect x="50" y="50" width="85" height="26" rx="2" fill="#444446" class="v10-install-plank v10-ip-3"/>
													<rect x="140" y="50" width="50" height="26" rx="2" fill="#3e3e40" class="v10-install-plank v10-ip-4"/>
													<rect x="10" y="80" width="85" height="26" rx="2" fill="#3e3e40" class="v10-install-plank v10-ip-5"/>
													<rect x="100" y="80" width="85" height="26" rx="2" fill="#444446" class="v10-install-plank v10-ip-6" opacity="0.5" stroke-dasharray="3 2"/>
												</g>
												<g class="v10-click-indicator">
										...
										{:else if mat === 'sheet'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1.2" fill="none">
													...
													<path d="M30 100 Q30 90 40 90 L160 90" stroke="#4a4a4c" stroke-width="3" fill="none" class="v10-sheet-unroll"/>
													<path d="M33 40 L33 100 Q33 108 40 108" stroke="#d4b87a" stroke-width="1.5" stroke-dasharray="4 2" class="v10-cove-line"/>
													<circle cx="175" cy="85" r="12" stroke="#4a4a4c" stroke-width="1.5" fill="#2a2a2c" class="v10-roll"/>
										...
										{:else if mat === 'hardwood'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													...
													<line x1="60" y1="45" x2="65" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v10-nail"/>
													<line x1="120" y1="45" x2="125" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v10-nail v10-nail-2"/>
													<rect x="45" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v10-nailer"/>
													<rect x="105" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v10-nailer v10-nailer-2"/>
												</g>
										...
										{:else if mat === 'rubber'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													<path d="M10 85 Q20 80 30 85 Q40 90 50 85 Q60 80 70 85 Q80 90 90 85 Q100 80 110 85 Q120 90 130 85 Q140 80 150 85 Q160 90 170 85 Q180 80 190 85" stroke="#555" stroke-width="1" class="v10-adhesive"/>
													<rect x="10" y="55" width="55" height="25" rx="2" fill="#3a3a3c" class="v10-rubber-tile v10-rt-1"/>
													<rect x="70" y="55" width="55" height="25" rx="2" fill="#444446" class="v10-rubber-tile v10-rt-2"/>
													<rect x="130" y="40" width="55" height="25" rx="2" fill="#3a3a3c" class="v10-rubber-tile v10-rt-3" opacity="0.6" stroke-dasharray="3 2"/>
												</g>
												<g class="v10-trowel" transform="translate(140,20)">
										...
										{:else if mat === 'ceramic'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													...
													<rect x="12" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v10-ceramic-tile v10-ct-1"/>
													<rect x="58" y="55" width="42" height="28" rx="1" fill="#484848" class="v10-ceramic-tile v10-ct-2"/>
													<rect x="104" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v10-ceramic-tile v10-ct-3"/>
													<rect x="150" y="45" width="42" height="28" rx="1" fill="#484848" class="v10-ceramic-tile v10-ct-4" opacity="0.5" stroke-dasharray="3 2"/>
									...
									<h3 class="v10-install-method">{install.method}</h3>
								</div>
								<div class="v10-tab-text">
									<p>{install.desc}</p>
								</div>
						...
						{:else if activeTab === 'maintenance'}
							<!-- == MAINTENANCE TAB == -->
							<div class="v10-tab-content v10-tab-enter">
								<div class="v10-maint-visual">
									<div class="v10-maint-icon">
										<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
											<g stroke="#606062" stroke-width="1.5" fill="none">
												...
												<g stroke="#d4b87a" stroke-width="1" class="v10-sparkle">
								...
								<div class="v10-maint-info">
									<div class="v10-maint-block">
										<h4>Daily Care</h4>
										<p>{maint.daily}</p>
									</div>
									<div class="v10-maint-block">
									...
									<div class="v10-maint-block v10-maint-avoid">
										<h4>Avoid</h4>
										<p>{maint.avoid}</p>
									</div>
								</div>
	...
	<!-- Version nav -->
	<div class="v-nav"><a href="/young-carpets">Main</a><a href="/young-carpets/dev/v7">V7</a><a href="/young-carpets/dev/v8">V8</a><a href="/young-carpets/dev/v9">V9</a><span class="v-nav-current">V10</span><a href="/young-carpets/dev/v11">V11</a><a href="/young-carpets/dev/v12">V12</a></div>

	<!-- Footer — minimal -->
	<footer class="v10-footer">
		<div class="yc-container">
			<div class="v10-footer-inner">
				<div class="v10-footer-brand">
					<span class="v10-footer-brand-name">YOUNG</span>
					<span class="v10-footer-brand-sub">Carpets Inc.</span>
				</div>
				<div class="v10-footer-info">
...
<style>
	...
	:global(.yc-page.v10) {
		...
		--v10-ink: #0b0b0d;
		--v10-text: #c8c8ca;
		--v10-text-muted: rgba(200,200,202,0.5);
		--v10-electric: rgba(140, 180, 255, 0.15);
		--v10-electric-hover: rgba(140, 180, 255, 0.25);
	}

	/* == Squared pills (12px) == */
	:global(.yc-page.v10 .yc-section-eyebrow),
	:global(.yc-page.v10 .yc-badge),
	:global(.yc-page.v10 .yc-chip),
	:global(.yc-page.v10 .yc-map-preview-pill),
	:global(.yc-page.v10 .yc-dev-version-badge),
	:global(.yc-page.v10 .yc-stat-number),
	:global(.yc-page.v10 .yc-modal-close),
	:global(.yc-page.v10 .yc-supplier-chip),
	:global(.yc-page.v10 .yc-modal-tab),
	:global(.yc-page.v10 .yc-modal-tab-btn),
	:global(.yc-page.v10 .yc-back-link) {
	...
	.v10-nav-section {
		...
		color: var(--v10-text-muted, rgba(200,200,202,0.6));
		margin-left: 0.75rem;
		white-space: nowrap;
		overflow: hidden;
		text-overflow: ellipsis;
		opacity: 0;
		animation: v10-fade-in 300ms ease forwards;
	}
	...
	.v10-hamburger-bar.open:nth-child(1) { transform: rotate(45deg) translate(5px, 5px); }
	.v10-hamburger-bar.open:nth-child(2) { opacity: 0; }
	.v10-hamburger-bar.open:nth-child(3) { transform: rotate(-45deg) translate(5px, -5px); }
	.v10-mobile-menu {
		width: 100%;
		display: flex;
		flex-direction: column;
	...
	.v10-mobile-menu button {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.7rem;
		font-weight: 700;
		letter-spacing: 0.08em;
		text-transform: uppercase;
		color: var(--v10-text-muted, rgba(200,200,200,0.6));
		background: transparent;
		border: none;
	...
	.v10-hero-tag {
		...
		letter-spacing: 0.12em;
		text-transform: uppercase;
		color: var(--v10-text-muted, rgba(200,200,202,0.5));
	...
	.v10-wordmark--ready .v10-wordmark__char {
		animation: v10-letter-in 700ms cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
		animation-delay: calc(var(--young-i, 0) * 80ms);
		will-change: transform, opacity;
	}
	@keyframes v10-letter-in {
		to {
			opacity: 1;
	...
	.v10-cta-primary:hover {
		border-color: var(--v10-electric-hover, rgba(140,180,255,0.25));
		box-shadow: 0 0 12px var(--v10-electric, rgba(140,180,255,0.15));
	}
	.v10-cta-secondary {
		display: inline-flex;
		align-items: center;
	...
	/* == Map — bigger == */
	:global(.yc-page.v10 .yc-map-preview) {
	...
	.v10-contact-card .v10-person-card {
		background: transparent;
		border: none;
	...
	.v10-contact-card .v10-person-card:last-child {
		border-bottom: none;
	}
	...
	.v10-modal-backdrop {
		...
		justify-content: center;
		padding: 1rem;
		animation: v10-backdrop-in 200ms ease;
	}
	@keyframes v10-backdrop-in {
		from { opacity: 0; }
		to { opacity: 1; }
	}
	...
	.v10-modal {
		...
		border-radius: 20px;
		padding: 1.5rem;
		animation: v10-modal-in 300ms cubic-bezier(0.34, 1.56, 0.64, 1);
	}
	@keyframes v10-modal-in {
	...
	.v10-tab-btn {
		...
		background: transparent;
		color: var(--v10-text-muted, rgba(200,200,200,0.5));
		cursor: pointer;
	...
	.v10-tab-enter {
		animation: v10-tab-slide 300ms ease-out;
	}
	@keyframes v10-tab-slide {
	...
	.v10-cs-layer {
		...
		position: relative;
		animation: v10-layer-slide 400ms ease-out backwards;
		animation-delay: calc(var(--layer-i, 0) * 80ms);
	}
	@keyframes v10-layer-slide {
		from {
			opacity: 0;
	...
	.v10-cs-layer:hover .v10-cs-layer-fill {
	...
	/* Install animations */
	.v10-install-tile {
		animation: v10-tile-place 400ms ease-out backwards;
	}
	.v10-it-1 { animation-delay: 0ms; }
	.v10-it-2 { animation-delay: 60ms; }
	.v10-it-3 { animation-delay: 120ms; }
	.v10-it-4 { animation-delay: 180ms; }
	.v10-it-5 { animation-delay: 240ms; }
	.v10-it-6 { animation-delay: 300ms; }
	.v10-it-7 { animation-delay: 360ms; }
	.v10-it-8 { animation-delay: 420ms; }
	.v10-it-9 { animation-delay: 480ms; }

	@keyframes v10-tile-place {
		from { opacity: 0; transform: translateY(-8px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v10-install-plank {
		animation: v10-plank-snap 350ms ease-out backwards;
	}
	.v10-ip-1 { animation-delay: 0ms; }
	.v10-ip-2 { animation-delay: 80ms; }
	.v10-ip-3 { animation-delay: 160ms; }
	.v10-ip-4 { animation-delay: 240ms; }
	.v10-ip-5 { animation-delay: 320ms; }
	.v10-ip-6 { animation-delay: 400ms; }

	@keyframes v10-plank-snap {
		from { opacity: 0; transform: translateX(12px); }
		to { opacity: 1; transform: translateX(0); }
	}

	.v10-click-indicator {
		animation: v10-click-pulse 1.5s ease-in-out infinite;
	}
	@keyframes v10-click-pulse {
		0%, 100% { opacity: 0.5; }
		50% { opacity: 1; }
	}

	.v10-ceramic-tile {
		animation: v10-tile-drop 400ms ease-out backwards;
	}
	.v10-ct-1 { animation-delay: 0ms; }
	.v10-ct-2 { animation-delay: 100ms; }
	.v10-ct-3 { animation-delay: 200ms; }
	.v10-ct-4 { animation-delay: 300ms; }

	@keyframes v10-tile-drop {
		from { opacity: 0; transform: translateY(-12px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v10-rubber-tile {
		animation: v10-rubber-place 400ms ease-out backwards;
	}
	.v10-rt-1 { animation-delay: 0ms; }
	.v10-rt-2 { animation-delay: 120ms; }
	.v10-rt-3 { animation-delay: 240ms; }

	@keyframes v10-rubber-place {
		from { opacity: 0; transform: translateY(-6px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v10-nail {
		animation: v10-nail-drive 500ms ease-out backwards;
		animation-delay: 200ms;
	}
	.v10-nail-2 {
		animation-delay: 500ms;
	}
	@keyframes v10-nail-drive {
	...
	.v10-sheet-unroll {
		...
		animation: v10-unroll 800ms ease-out forwards;
		animation-delay: 200ms;
	}
	@keyframes v10-unroll {
	...
	.v10-cove-line {
		...
		animation: v10-cove-draw 600ms ease-out forwards;
		animation-delay: 400ms;
	}
	@keyframes v10-cove-draw {
		to { stroke-dashoffset: 0; }
	}
	...
	.v10-sparkle {
		animation: v10-sparkle-pulse 2s ease-in-out infinite;
	}
	@keyframes v10-sparkle-pulse {
		0%, 100% { opacity: 0.4; }
		50% { opacity: 1; }
	}
	...
	/* ============================================================
	   V10 "COME ALIVE" — Scroll-activated section effects
	   ============================================================ */
	...
	/* Maple leaf moonlight glow */
	.yc-hero .v10-hero-maple {
		position: relative;
	}
	.yc-hero .v10-hero-maple::after {
		content: '';
		position: absolute;
		inset: -20px;
		border-radius: 50%;
	...
	.yc-hero.alive .v10-hero-maple::after {
		opacity: 1;
	}

	/* Stats brightness pulse */
	.v10-hero-stats {
		opacity: 0.5;
		transition: opacity 600ms ease-out;
	}
	.yc-hero.alive .v10-hero-stats {
		animation: v10-stats-pulse 1.2s ease-out 800ms;
		opacity: 1;
	}
	@keyframes v10-stats-pulse {
	...
	:global(.yc-page.v10 .yc-section--products .yc-product-card) {
		opacity: 0.7;
		transition: opacity 600ms ease-out, box-shadow 200ms ease;
		will-change: opacity, box-shadow;
	}
	:global(.yc-page.v10 .yc-section--products.alive .yc-product-card) {
		opacity: 1;
		box-shadow: 0 2px 8px rgba(140,180,255,0.04);
	}
	:global(.yc-page.v10 .yc-section--products .yc-product-card:hover) {
		box-shadow:
			inset 0 1px 0 var(--yc-sheen-08, rgba(255,255,255,0.08)),
			0 8px 32px rgba(0,0,0,0.45),
			0 0 20px rgba(140,180,255,0.12) !important;
		border-color: rgba(140,180,255,0.25) !important;
	}

	/* -- Services section alive with scanner line -- */
	:global(.yc-page.v10 .yc-section--services) {
		position: relative;
		overflow: hidden;
	}
	:global(.yc-page.v10 .yc-section--services .yc-card) {
		opacity: 0.7;
		transition: opacity 600ms ease-out;
		will-change: opacity;
	}
	:global(.yc-page.v10 .yc-section--services.alive .yc-card) {
		opacity: 1;
	}
	:global(.yc-page.v10 .yc-section--services::before) {
		content: '';
		position: absolute;
		top: 0;
		left: -100%;
		width: 100%;
		height: 1px;
		background: linear-gradient(90deg, transparent 0%, rgba(140,180,255,0.25) 50%, transparent 100%);
		pointer-events: none;
		opacity: 0;
	}
	:global(.yc-page.v10 .yc-section--services.alive::before) {
		opacity: 1;
		animation: v10-scanner-sweep 1.2s ease-out forwards;
	}
	@keyframes v10-scanner-sweep {
		from { left: -100%; }
		to { left: 100%; }
	}

	/* -- Map section alive (brightens) -- */
	:global(.yc-page.v10 .yc-map-section .yc-map-preview-iframe) {
		filter: brightness(0.7);
		transition: filter 600ms ease-out;
	}
	:global(.yc-page.v10 .yc-map-section.alive .yc-map-preview-iframe) {
		filter: brightness(1);
	}

	/* -- Contact section alive (pulse glow on person cards) -- */
	:global(.yc-page.v10 .yc-section--contact) {
		position: relative;
	}
	.v10-person-card {
	...
	:global(.yc-page.v10 .yc-section--contact.alive) .v10-person-card {
		opacity: 1;
		animation: v10-contact-pulse 2s ease-in-out;
	}
	@keyframes v10-contact-pulse {
		0% { box-shadow: 0 0 0 rgba(140,180,255,0); }
		40% { box-shadow: 0 0 12px rgba(140,180,255,0.1); }
		100% { box-shadow: 0 0 0 rgba(140,180,255,0); }
	}

	/* -- Suppliers alive -- */
	:global(.yc-page.v10 .yc-section--suppliers) {
		opacity: 0.7;
		transition: opacity 600ms ease-out;
	}
	:global(.yc-page.v10 .yc-section--suppliers.alive) {
		opacity: 1;
	}
</style>