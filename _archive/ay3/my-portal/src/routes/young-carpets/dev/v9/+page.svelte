<!--
	Young Carpets V9 — "Product Depth"
	Rich interactive product tab content with animated cross-section
	diagrams, install technique visuals, and maintenance illustrations.
	Built on V8's clean minimal layout.
	2026-04-09
-->
<script lang="ts">
...
<div class="yc-page v9" bind:this={pageEl}>
	{#if dev}
		<div class="yc-dev-version-badge" aria-hidden="true">v{ycVersion} · V9</div>
	{/if}

	<!-- Scroll progress indicator -->
	<div class="v9-progress" style="transform: scaleX({scrollProgress})" aria-hidden="true"></div>
	...
	<!-- Navbar -->
	<nav class="v9-nav">
		<div class="v9-nav-left">
			<a href="/young-carpets/dev/v9" class="v9-nav-brand">YOUNG</a>
			{#if activeSection && sectionMap[activeSection]}
				<span class="v9-nav-section">{sectionMap[activeSection]}</span>
			{/if}
		</div>
		<div class="v9-nav-right">
			<ThemeToggle />
			<button
				class="v9-hamburger"
			...
			>
				<span class="v9-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v9-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v9-hamburger-bar" class:open={mobileMenuOpen}></span>
			</button>
		</div>
		{#if mobileMenuOpen}
			<div class="v9-mobile-menu">
				<button onclick={() => v9ScrollTo('products')}>Products</button>
				<button onclick={() => v9ScrollTo('what')}>Services</button>
				<button onclick={() => v9ScrollTo('contact')}>Contact</button>
			</div>
		{/if}
	</nav>
	...
	<section class="yc-hero">
		<div class="yc-container">
			<div class="v9-hero-maple" aria-label="Proudly Canadian">
			...
			<p class="v9-hero-tag">Commercial Flooring &middot; Ottawa, Ontario</p>
			<h1 class="v9-wordmark" class:v9-wordmark--ready={wordmarkReady} aria-label="Young">
				{#each LETTERS as ch, i (ch + i)}
					<span
						class="v9-wordmark__char"
						style="--young-i: {i};"
						aria-hidden="true"
					>{ch}</span>
				{/each}
			...
			<div class="v9-hero-actions">
				<button class="v9-cta-primary" onclick={() => v9ScrollTo('products')}>
					View Products
				</button>
				<a href="tel:613-744-2744" class="v9-cta-secondary">
					Call Us
				</a>
			</div>
			<div class="v9-hero-stats">
				<div class="v9-stat">
					<span class="v9-stat-number" use:countUp data-target="250" data-suffix="+">0</span>
					<span class="v9-stat-label">combined years</span>
				</div>
				<div class="v9-stat">
					<span class="v9-stat-number" use:countUp data-target="50000" data-suffix="+">0</span>
					<span class="v9-stat-label">jobs completed</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contact" class="yc-section yc-section--contact" use:reveal>
		<div class="yc-container">
			...
			<div class="v9-contact-grid">
				<div class="v9-contact-people">
					{#each [
				...
				<div class="v9-contact-side">
					<div class="v9-contact-card">
						<h3>Accounting</h3>
						<div class="v9-person-card">
	...
	{#if openProduct}
		...
		<div class="v9-modal-backdrop" onclick={closeProduct}>
			<!-- svelte-ignore a11y_no_static_element_interactions -->
			<div class="v9-modal" onclick={(e) => e.stopPropagation()}>
				<button class="v9-modal-close" onclick={closeProduct} aria-label="Close">
				...
				<div class="v9-modal-header">
					<span class="v9-modal-code">{openProduct.code}</span>
					{#if openProduct.nameHtml}
						<h2 class="v9-modal-title">{@html openProduct.nameHtml}</h2>
					{:else}
						<h2 class="v9-modal-title">{openProduct.name}</h2>
					{/if}
				</div>

				<!-- Tab buttons -->
				<div class="v9-modal-tabs">
					<button
						class="v9-tab-btn"
						class:v9-tab-btn--active={activeTab === 'product'}
						onclick={() => switchTab('product')}
					>Product</button>
					<button
						class="v9-tab-btn"
						class:v9-tab-btn--active={activeTab === 'install'}
						onclick={() => switchTab('install')}
					>Install</button>
					<button
						class="v9-tab-btn"
						class:v9-tab-btn--active={activeTab === 'maintenance'}
				...
				<div class="v9-modal-body">
					{#key tabAnimKey}
						{#if activeTab === 'product'}
							...
							<div class="v9-tab-content v9-tab-enter">
								<div class="v9-cross-section">
									<div class="v9-cs-title-row">
										...
										<span class="v9-cs-label">Cross-Section</span>
									</div>
									<div class="v9-cs-diagram">
										{#each layers as layer, li}
											<div
												...
												"
											>
												<div class="v9-cs-layer-fill"></div>
												<span class="v9-cs-layer-label">{layer.label}</span>
												<div class="v9-cs-dim-line">
													<span class="v9-cs-dim-cap"></span>
													<span class="v9-cs-dim-stem"></span>
													<span class="v9-cs-dim-cap"></span>
												</div>
											</div>
										{/each}
						...
						{:else if activeTab === 'install'}
							<!-- == INSTALL TAB == -->
							<div class="v9-tab-content v9-tab-enter">
								<div class="v9-install-visual">
									<div class="v9-install-icon">
										{#if mat === 'carpet-tile'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1.2" fill="none">
													<rect x="10" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v9-install-tile v9-it-1"/>
													<rect x="55" y="10" width="40" height="40" rx="2" fill="#444446" class="v9-install-tile v9-it-2"/>
													<rect x="100" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v9-install-tile v9-it-3"/>
													<rect x="145" y="10" width="40" height="40" rx="2" fill="#444446" class="v9-install-tile v9-it-4"/>
													<rect x="10" y="55" width="40" height="40" rx="2" fill="#444446" class="v9-install-tile v9-it-5"/>
													<rect x="55" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v9-install-tile v9-it-6"/>
													<rect x="100" y="55" width="40" height="40" rx="2" fill="#444446" class="v9-install-tile v9-it-7"/>
													<rect x="145" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v9-install-tile v9-it-8"/>
													<rect x="10" y="100" width="40" height="40" rx="2" fill="#3a3a3c" class="v9-install-tile v9-it-9" opacity="0.4" stroke-dasharray="3 2"/>
												</g>
												<path d="M30 135 L30 115" stroke="#d4b87a" stroke-width="1.5" fill="none" marker-end="url(#v9arr)"/>
												<defs><marker id="v9arr" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#d4b87a"/></marker></defs>
											</svg>
										{:else if mat === 'lvt'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													<rect x="10" y="20" width="85" height="26" rx="2" fill="#3e3e40" class="v9-install-plank v9-ip-1"/>
													<rect x="100" y="20" width="85" height="26" rx="2" fill="#444446" class="v9-install-plank v9-ip-2"/>
													<rect x="50" y="50" width="85" height="26" rx="2" fill="#444446" class="v9-install-plank v9-ip-3"/>
													<rect x="140" y="50" width="50" height="26" rx="2" fill="#3e3e40" class="v9-install-plank v9-ip-4"/>
													<rect x="10" y="80" width="85" height="26" rx="2" fill="#3e3e40" class="v9-install-plank v9-ip-5"/>
													<rect x="100" y="80" width="85" height="26" rx="2" fill="#444446" class="v9-install-plank v9-ip-6" opacity="0.5" stroke-dasharray="3 2"/>
												</g>
												<g class="v9-click-indicator">
										...
										{:else if mat === 'sheet'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1.2" fill="none">
													...
													<path d="M30 100 Q30 90 40 90 L160 90" stroke="#4a4a4c" stroke-width="3" fill="none" class="v9-sheet-unroll"/>
													<path d="M33 40 L33 100 Q33 108 40 108" stroke="#d4b87a" stroke-width="1.5" stroke-dasharray="4 2" class="v9-cove-line"/>
													<circle cx="175" cy="85" r="12" stroke="#4a4a4c" stroke-width="1.5" fill="#2a2a2c" class="v9-roll"/>
										...
										{:else if mat === 'hardwood'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													...
													<line x1="60" y1="45" x2="65" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v9-nail"/>
													<line x1="120" y1="45" x2="125" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v9-nail v9-nail-2"/>
													<rect x="45" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v9-nailer"/>
													<rect x="105" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v9-nailer v9-nailer-2"/>
												</g>
										...
										{:else if mat === 'rubber'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													<path d="M10 85 Q20 80 30 85 Q40 90 50 85 Q60 80 70 85 Q80 90 90 85 Q100 80 110 85 Q120 90 130 85 Q140 80 150 85 Q160 90 170 85 Q180 80 190 85" stroke="#555" stroke-width="1" class="v9-adhesive"/>
													<rect x="10" y="55" width="55" height="25" rx="2" fill="#3a3a3c" class="v9-rubber-tile v9-rt-1"/>
													<rect x="70" y="55" width="55" height="25" rx="2" fill="#444446" class="v9-rubber-tile v9-rt-2"/>
													<rect x="130" y="40" width="55" height="25" rx="2" fill="#3a3a3c" class="v9-rubber-tile v9-rt-3" opacity="0.6" stroke-dasharray="3 2"/>
												</g>
												<g class="v9-trowel" transform="translate(140,20)">
										...
										{:else if mat === 'ceramic'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
												<g stroke="#606062" stroke-width="1" fill="none">
													...
													<rect x="12" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v9-ceramic-tile v9-ct-1"/>
													<rect x="58" y="55" width="42" height="28" rx="1" fill="#484848" class="v9-ceramic-tile v9-ct-2"/>
													<rect x="104" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v9-ceramic-tile v9-ct-3"/>
													<rect x="150" y="45" width="42" height="28" rx="1" fill="#484848" class="v9-ceramic-tile v9-ct-4" opacity="0.5" stroke-dasharray="3 2"/>
									...
									<h3 class="v9-install-method">{install.method}</h3>
								</div>
								<div class="v9-tab-text">
									<p>{install.desc}</p>
								</div>
						...
						{:else if activeTab === 'maintenance'}
							<!-- == MAINTENANCE TAB == -->
							<div class="v9-tab-content v9-tab-enter">
								<div class="v9-maint-visual">
									<div class="v9-maint-icon">
										<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
											<g stroke="#606062" stroke-width="1.5" fill="none">
												...
												<g stroke="#d4b87a" stroke-width="1" class="v9-sparkle">
								...
								<div class="v9-maint-info">
									<div class="v9-maint-block">
										<h4>Daily Care</h4>
										<p>{maint.daily}</p>
									</div>
									<div class="v9-maint-block">
									...
									<div class="v9-maint-block v9-maint-avoid">
										<h4>Avoid</h4>
										<p>{maint.avoid}</p>
									</div>
								</div>
	...
	<!-- Version nav -->
	<div class="v-nav"><a href="/young-carpets">Main</a><a href="/young-carpets/dev/v7">V7</a><a href="/young-carpets/dev/v8">V8</a><span class="v-nav-current">V9</span><a href="/young-carpets/dev/v10">V10</a><a href="/young-carpets/dev/v11">V11</a><a href="/young-carpets/dev/v12">V12</a></div>

	<!-- Footer — minimal -->
	<footer class="v9-footer">
		<div class="yc-container">
			<div class="v9-footer-inner">
				<div class="v9-footer-brand">
					<span class="v9-footer-brand-name">YOUNG</span>
					<span class="v9-footer-brand-sub">Carpets Inc.</span>
				</div>
				<div class="v9-footer-info">
...
<style>
	...
	:global(.yc-page.v9) {
		...
		--v9-ink: #0b0b0d;
		--v9-text: #c8c8ca;
		--v9-text-muted: rgba(200,200,202,0.5);
		--v9-electric: rgba(140, 180, 255, 0.15);
		--v9-electric-hover: rgba(140, 180, 255, 0.25);
	}

	/* == Squared pills (12px) == */
	:global(.yc-page.v9 .yc-section-eyebrow),
	:global(.yc-page.v9 .yc-badge),
	:global(.yc-page.v9 .yc-chip),
	:global(.yc-page.v9 .yc-map-preview-pill),
	:global(.yc-page.v9 .yc-dev-version-badge),
	:global(.yc-page.v9 .yc-stat-number),
	:global(.yc-page.v9 .yc-modal-close),
	:global(.yc-page.v9 .yc-supplier-chip),
	:global(.yc-page.v9 .yc-modal-tab),
	:global(.yc-page.v9 .yc-modal-tab-btn),
	:global(.yc-page.v9 .yc-back-link) {
	...
	.v9-nav-section {
		...
		opacity: 0;
		animation: v9-fade-in 300ms ease forwards;
	}
	...
	.v9-hamburger-bar.open:nth-child(1) { transform: rotate(45deg) translate(5px, 5px); }
	.v9-hamburger-bar.open:nth-child(2) { opacity: 0; }
	.v9-hamburger-bar.open:nth-child(3) { transform: rotate(-45deg) translate(5px, -5px); }
	.v9-mobile-menu {
		width: 100%;
		display: flex;
		flex-direction: column;
	...
	.v9-mobile-menu button {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.7rem;
		font-weight: 700;
		letter-spacing: 0.08em;
		text-transform: uppercase;
		color: var(--v9-text-muted, rgba(200,200,200,0.6));
		background: transparent;
		border: none;
	...
	.v9-wordmark--ready .v9-wordmark__char {
		animation: v9-letter-in 700ms cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
		animation-delay: calc(var(--young-i, 0) * 80ms);
		will-change: transform, opacity;
	}
	@keyframes v9-letter-in {
		to {
			opacity: 1;
	...
	.v9-cta-primary:hover {
		border-color: var(--v9-electric-hover, rgba(140,180,255,0.25));
		box-shadow: 0 0 12px var(--v9-electric, rgba(140,180,255,0.15));
	}
	.v9-cta-secondary {
		display: inline-flex;
		align-items: center;
	...
	.v9-cta-secondary:hover {
		color: var(--yc-maple-gold, #d4b87a);
		border-color: var(--yc-maple-gold-35, rgba(212,184,122,0.35));
	}
	...
	.v9-stat-label {
		...
		letter-spacing: 0.06em;
		text-transform: uppercase;
		color: var(--v9-text-muted, rgba(200,200,202,0.5));
	}

	/* == Products eyebrow gold == */
	:global(.yc-page.v9 .yc-section-eyebrow) {
		color: var(--yc-maple-gold, #d4b87a);
	}

	/* Electric hover glow on product cards */
	:global(.yc-page.v9 .yc-product-card:hover) {
		border-color: var(--v9-electric-hover, rgba(140,180,255,0.25)) !important;
		box-shadow:
			inset 0 1px 0 var(--yc-sheen-08, rgba(255,255,255,0.08)),
			0 8px 32px rgba(0,0,0,0.45),
			0 0 16px var(--v9-electric, rgba(140,180,255,0.15)) !important;
	}
	...
	/* == Map — bigger == */
	:global(.yc-page.v9 .yc-map-preview) {
	...
	.v9-contact-card .v9-person-card {
		background: transparent;
		border: none;
	...
	.v9-contact-card .v9-person-card:last-child {
		border-bottom: none;
	}
	...
	.v9-modal-backdrop {
		...
		justify-content: center;
		padding: 1rem;
		animation: v9-backdrop-in 200ms ease;
	}
	@keyframes v9-backdrop-in {
		from { opacity: 0; }
		to { opacity: 1; }
	}
	...
	.v9-modal {
		...
		border-radius: 20px;
		padding: 1.5rem;
		animation: v9-modal-in 300ms cubic-bezier(0.34, 1.56, 0.64, 1);
	}
	@keyframes v9-modal-in {
	...
	.v9-tab-btn {
		...
		background: transparent;
		color: var(--v9-text-muted, rgba(200,200,200,0.5));
		cursor: pointer;
	...
	.v9-tab-btn--active {
		color: var(--yc-maple-gold, #d4b87a);
		border-color: var(--yc-maple-gold-35, rgba(212,184,122,0.35));
		background: var(--yc-maple-gold-08, rgba(212,184,122,0.08));
	}

	/* Tab content animation */
	.v9-tab-enter {
		animation: v9-tab-slide 300ms ease-out;
	}
	@keyframes v9-tab-slide {
	...
	.v9-cs-layer {
		...
		position: relative;
		animation: v9-layer-slide 400ms ease-out backwards;
		animation-delay: calc(var(--layer-i, 0) * 80ms);
	}
	@keyframes v9-layer-slide {
		from {
			opacity: 0;
	...
	.v9-cs-layer:hover .v9-cs-layer-fill {
	...
	.v9-cs-layer-label {
		...
		font-weight: 500;
		letter-spacing: 0.04em;
		color: var(--v9-text-muted, rgba(200,200,202,0.6));
		white-space: nowrap;
		flex-shrink: 0;
		width: 140px;
		text-align: right;
	...
	/* Install animations */
	.v9-install-tile {
		animation: v9-tile-place 400ms ease-out backwards;
	}
	.v9-it-1 { animation-delay: 0ms; }
	.v9-it-2 { animation-delay: 60ms; }
	.v9-it-3 { animation-delay: 120ms; }
	.v9-it-4 { animation-delay: 180ms; }
	.v9-it-5 { animation-delay: 240ms; }
	.v9-it-6 { animation-delay: 300ms; }
	.v9-it-7 { animation-delay: 360ms; }
	.v9-it-8 { animation-delay: 420ms; }
	.v9-it-9 { animation-delay: 480ms; }

	@keyframes v9-tile-place {
		from { opacity: 0; transform: translateY(-8px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v9-install-plank {
		animation: v9-plank-snap 350ms ease-out backwards;
	}
	.v9-ip-1 { animation-delay: 0ms; }
	.v9-ip-2 { animation-delay: 80ms; }
	.v9-ip-3 { animation-delay: 160ms; }
	.v9-ip-4 { animation-delay: 240ms; }
	.v9-ip-5 { animation-delay: 320ms; }
	.v9-ip-6 { animation-delay: 400ms; }

	@keyframes v9-plank-snap {
		from { opacity: 0; transform: translateX(12px); }
		to { opacity: 1; transform: translateX(0); }
	}

	.v9-click-indicator {
		animation: v9-click-pulse 1.5s ease-in-out infinite;
	}
	@keyframes v9-click-pulse {
		0%, 100% { opacity: 0.5; }
		50% { opacity: 1; }
	}

	.v9-ceramic-tile {
		animation: v9-tile-drop 400ms ease-out backwards;
	}
	.v9-ct-1 { animation-delay: 0ms; }
	.v9-ct-2 { animation-delay: 100ms; }
	.v9-ct-3 { animation-delay: 200ms; }
	.v9-ct-4 { animation-delay: 300ms; }

	@keyframes v9-tile-drop {
		from { opacity: 0; transform: translateY(-12px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v9-rubber-tile {
		animation: v9-rubber-place 400ms ease-out backwards;
	}
	.v9-rt-1 { animation-delay: 0ms; }
	.v9-rt-2 { animation-delay: 120ms; }
	.v9-rt-3 { animation-delay: 240ms; }

	@keyframes v9-rubber-place {
		from { opacity: 0; transform: translateY(-6px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v9-nail {
		animation: v9-nail-drive 500ms ease-out backwards;
		animation-delay: 200ms;
	}
	.v9-nail-2 {
		animation-delay: 500ms;
	}
	@keyframes v9-nail-drive {
	...
	.v9-sheet-unroll {
		...
		animation: v9-unroll 800ms ease-out forwards;
		animation-delay: 200ms;
	}
	@keyframes v9-unroll {
	...
	.v9-cove-line {
		...
		animation: v9-cove-draw 600ms ease-out forwards;
		animation-delay: 400ms;
	}
	@keyframes v9-cove-draw {
		to { stroke-dashoffset: 0; }
	}
	...
	.v9-sparkle {
		animation: v9-sparkle-pulse 2s ease-in-out infinite;
	}
	@keyframes v9-sparkle-pulse {
		0%, 100% { opacity: 0.4; }
		50% { opacity: 1; }
	}
