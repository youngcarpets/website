<!--
	Young Carpets V8 — "Clean Slate"
	Refined, minimal single-page site. Super clean first impression.
	  1. Hero: maple leaf, YOUNG wordmark, tagline, CTAs, inline stat counters
	  2. Products: 9 cards with SVG textures, no "Also", no "Search by", no eyebrow
	  3. Suppliers: marquee
	  4. Services: 3 cards (simplified from 4)
	  5. Map: bigger
	  6. Contact: V6 gold standard consolidated
	  7. Footer: minimal
	  - No "About Us" section
	  - Greyscale-first + muted gold accent
	  - Electric blue-white for card hover glows
	2026-04-09
-->
<script lang="ts">
	...
	onMount(() => {
		...
		const start = async () => {
			...
			} catch { /* font load failed — reveal anyway */ }
...
<div class="yc-page v8" bind:this={pageEl}>
	{#if dev}
		<div class="yc-dev-version-badge" aria-hidden="true">v{ycVersion} · V8</div>
	{/if}

	<!-- Scroll progress indicator -->
	<div class="v8-progress" style="transform: scaleX({scrollProgress})" aria-hidden="true"></div>
	...
	<!-- Navbar -->
	<nav class="v8-nav">
		<div class="v8-nav-left">
			<a href="/young-carpets/dev/v8" class="v8-nav-brand">YOUNG</a>
			{#if activeSection && sectionMap[activeSection]}
				<span class="v8-nav-section">{sectionMap[activeSection]}</span>
			{/if}
		</div>
		<div class="v8-nav-right">
			<ThemeToggle />
			<button
				class="v8-hamburger"
			...
			>
				<span class="v8-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v8-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v8-hamburger-bar" class:open={mobileMenuOpen}></span>
			</button>
		</div>
		{#if mobileMenuOpen}
			<div class="v8-mobile-menu">
				<button onclick={() => v8ScrollTo('products')}>Products</button>
				<button onclick={() => v8ScrollTo('what')}>Services</button>
				<button onclick={() => v8ScrollTo('contact')}>Contact</button>
			</div>
		{/if}
	</nav>
	...
	<section class="yc-hero">
		<div class="yc-container">
			<div class="v8-hero-maple" aria-label="Proudly Canadian">
			...
			<p class="v8-hero-tag">Commercial Flooring &middot; Ottawa, Ontario</p>
			<h1 class="v8-wordmark" class:v8-wordmark--ready={wordmarkReady} aria-label="Young">
				{#each LETTERS as ch, i (ch + i)}
					<span
						class="v8-wordmark__char"
						style="--young-i: {i};"
						aria-hidden="true"
					>{ch}</span>
				{/each}
			...
			<div class="v8-hero-actions">
				<button class="v8-cta-primary" onclick={() => v8ScrollTo('products')}>
					View Products
				</button>
				<a href="tel:613-744-2744" class="v8-cta-secondary">
					Call Us
				</a>
			</div>
			<div class="v8-hero-stats">
				<div class="v8-stat">
					<span class="v8-stat-number" use:countUp data-target="250" data-suffix="+">0</span>
					<span class="v8-stat-label">combined years</span>
				</div>
				<div class="v8-stat">
					<span class="v8-stat-number" use:countUp data-target="50000" data-suffix="+">0</span>
					<span class="v8-stat-label">jobs completed</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contact" class="yc-section yc-section--contact" use:reveal>
		<div class="yc-container">
			...
			<div class="v8-contact-grid">
				<div class="v8-contact-people">
					{#each [
				...
				<div class="v8-contact-side">
					<div class="v8-contact-card">
						<h3>Accounting</h3>
						<div class="v8-person-card">
	...
	<!-- Version nav -->
	<div class="v-nav"><a href="/young-carpets">Main</a><a href="/young-carpets/dev/v7">V7</a><span class="v-nav-current">V8</span><a href="/young-carpets/dev/v9">V9</a><a href="/young-carpets/dev/v10">V10</a><a href="/young-carpets/dev/v11">V11</a><a href="/young-carpets/dev/v12">V12</a></div>

	<!-- Footer — minimal -->
	<footer class="v8-footer">
		<div class="yc-container">
			<div class="v8-footer-inner">
				<div class="v8-footer-brand">
					<span class="v8-footer-brand-name">YOUNG</span>
					<span class="v8-footer-brand-sub">Carpets Inc.</span>
				</div>
				<div class="v8-footer-info">
...
<style>
	...
	/* ── Color overrides — greyscale-first + muted gold accent ── */
	:global(.yc-page.v8) {
		...
		--v8-ink: #0b0b0d;
		--v8-text: #c8c8ca;
		--v8-text-muted: rgba(200, 200, 202, 0.5);
		--v8-electric: rgba(140, 180, 255, 0.15);
		--v8-electric-hover: rgba(140, 180, 255, 0.25);
	}

	/* ── Squared pills (12px) ── */
	:global(.yc-page.v8 .yc-section-eyebrow),
	:global(.yc-page.v8 .yc-badge),
	:global(.yc-page.v8 .yc-chip),
	:global(.yc-page.v8 .yc-map-preview-pill),
	:global(.yc-page.v8 .yc-dev-version-badge),
	:global(.yc-page.v8 .yc-stat-number),
	:global(.yc-page.v8 .yc-modal-close),
	:global(.yc-page.v8 .yc-supplier-chip),
	:global(.yc-page.v8 .yc-modal-tab),
	:global(.yc-page.v8 .yc-modal-tab-btn),
	:global(.yc-page.v8 .yc-back-link) {
	...
	:global(:root[data-theme='light']) .v8-nav {
	...
	.v8-nav-section {
		...
		opacity: 0;
		animation: v8-fade-in 300ms ease forwards;
	}
	...
	.v8-hamburger-bar.open:nth-child(1) { transform: rotate(45deg) translate(5px, 5px); }
	.v8-hamburger-bar.open:nth-child(2) { opacity: 0; }
	.v8-hamburger-bar.open:nth-child(3) { transform: rotate(-45deg) translate(5px, -5px); }
	.v8-mobile-menu {
		width: 100%;
		display: flex;
		flex-direction: column;
	...
	.v8-mobile-menu button {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.7rem;
		font-weight: 700;
		letter-spacing: 0.08em;
		text-transform: uppercase;
		color: var(--v8-text-muted, rgba(200,200,200,0.6));
		background: transparent;
		border: none;
	...
	.v8-wordmark--ready .v8-wordmark__char {
		animation: v8-letter-in 700ms cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
		animation-delay: calc(var(--young-i, 0) * 80ms);
		will-change: transform, opacity;
	}
	@keyframes v8-letter-in {
		to {
			opacity: 1;
	...
	.v8-cta-primary:hover {
		border-color: var(--v8-electric-hover, rgba(140,180,255,0.25));
		box-shadow: 0 0 12px var(--v8-electric, rgba(140,180,255,0.15));
	}
	.v8-cta-secondary {
		display: inline-flex;
		align-items: center;
	...
	.v8-stat-label {
		...
		letter-spacing: 0.06em;
		text-transform: uppercase;
		color: var(--v8-text-muted, rgba(200,200,202,0.5));
	}

	/* ── Products — eyebrow uses gold, no "Supply & Installation" ── */
	:global(.yc-page.v8 .yc-section-eyebrow) {
		color: var(--yc-maple-gold, #d4b87a);
	}

	/* Electric hover glow on product cards */
	:global(.yc-page.v8 .yc-product-card:hover) {
		border-color: var(--v8-electric-hover, rgba(140,180,255,0.25)) !important;
		box-shadow:
			inset 0 1px 0 var(--yc-sheen-08, rgba(255,255,255,0.08)),
			0 8px 32px rgba(0,0,0,0.45),
			0 0 16px var(--v8-electric, rgba(140,180,255,0.15)) !important;
	}
	...
	/* ── Map — bigger ── */
	:global(.yc-page.v8 .yc-map-preview) {
	...
	.v8-contact-card .v8-person-card {
		background: transparent;
		border: none;
	...
	.v8-contact-card .v8-person-card:last-child {
		border-bottom: none;
	}
