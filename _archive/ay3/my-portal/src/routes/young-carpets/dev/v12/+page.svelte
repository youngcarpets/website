<!--
	Young Carpets V12 — "Greatest Hits II"
	Cherry-picking the best of V8-V11 into one polished page:
	- V8's clean minimal layout
	- V9's product modal with interactive cross-section diagrams and install visuals
	- V10's "come alive" scroll effects (V11's subtler calibration)
	- V11's polish (typography, spacing, mobile, interactions)
	2026-04-09
-->
<script lang="ts">
	...
	function v12ScrollTo(id: string) {
	...
	/* Font loading + hero alive trigger */
	onMount(() => {
		let cancelled = false;
		const start = async () => {
			try {
	...
	/* "Come alive" IntersectionObserver for sections */
	$effect(() => {
		if (typeof window === 'undefined') return;
...
<div class="yc-page v12" bind:this={pageEl}>
	{#if dev}
		<div class="yc-dev-version-badge" aria-hidden="true">v{ycVersion} · V12</div>
	{/if}

	<!-- Scroll progress indicator -->
	<div class="v12-progress" style="transform: scaleX({scrollProgress})" aria-hidden="true"></div>
	...
	<!-- ===================== NAVBAR ===================== -->
	<nav class="v12-nav">
		<div class="v12-nav-left">
			<a href="/young-carpets/dev/v12" class="v12-nav-brand">YOUNG</a>
			{#if activeSection && sectionMap[activeSection]}
				<span class="v12-nav-section">{sectionMap[activeSection]}</span>
			{/if}
		</div>
		<div class="v12-nav-right">
			<ThemeToggle />
			<button
				class="v12-hamburger"
			...
			>
				<span class="v12-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v12-hamburger-bar" class:open={mobileMenuOpen}></span>
				<span class="v12-hamburger-bar" class:open={mobileMenuOpen}></span>
			</button>
		</div>
		{#if mobileMenuOpen}
			<div class="v12-mobile-menu">
				<button onclick={() => v12ScrollTo('products')}>Products</button>
				<button onclick={() => v12ScrollTo('what')}>Services</button>
				<button onclick={() => v12ScrollTo('contact')}>Contact</button>
			</div>
		{/if}
	</nav>
	...
	<section class="yc-hero" class:alive={heroAlive}>
		<div class="yc-container">
			<div class="v12-hero-maple" aria-label="Proudly Canadian">
			...
			<p class="v12-hero-tag">Commercial Flooring &middot; Ottawa, Ontario</p>
			<h1 class="v12-wordmark" class:v12-wordmark--ready={wordmarkReady} aria-label="Young">
				{#each LETTERS as ch, i (ch + i)}
					<span
						class="v12-wordmark__char"
						style="--young-i: {i};"
						aria-hidden="true"
					>{ch}</span>
				{/each}
			</h1>
			<p class="v12-hero-sub">
				Supply, installation, and maintenance &mdash; for offices, institutions, and retail.
			</p>
			<div class="v12-hero-actions">
				<button class="v12-cta-primary" onclick={() => v12ScrollTo('products')}>
					View Products
				</button>
				<a href="tel:613-744-2744" class="v12-cta-secondary">
					Call Us
				</a>
			</div>
			<div class="v12-hero-stats">
				<div class="v12-stat">
					<span class="v12-stat-number" use:countUp data-target="250" data-suffix="+">0</span>
					<span class="v12-stat-label">combined years</span>
				</div>
				<div class="v12-stat">
					<span class="v12-stat-number" use:countUp data-target="50000" data-suffix="+">0</span>
					<span class="v12-stat-label">jobs completed</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contact" class="yc-section yc-section--contact" use:reveal>
		<div class="yc-container">
			...
			<div class="v12-contact-grid">
				<div class="v12-contact-people">
					{#each [
				...
				<div class="v12-contact-side">
					<div class="v12-contact-card">
						<h3>Accounting</h3>
						<div class="v12-person-card">
	...
	{#if openProduct}
		...
		<div class="v12-modal-backdrop" onclick={closeProduct}>
			<!-- svelte-ignore a11y_no_static_element_interactions -->
			<div class="v12-modal" onclick={(e) => e.stopPropagation()}>
				<button class="v12-modal-close" onclick={closeProduct} aria-label="Close">
				...
				<div class="v12-modal-header">
					<span class="v12-modal-code">{openProduct.code}</span>
					{#if openProduct.nameHtml}
						<h2 class="v12-modal-title">{@html openProduct.nameHtml}</h2>
					{:else}
						<h2 class="v12-modal-title">{openProduct.name}</h2>
					{/if}
				</div>

				<!-- Tab buttons -->
				<div class="v12-modal-tabs">
					<button class="v12-tab-btn" class:v12-tab-btn--active={activeTab === 'product'} onclick={() => switchTab('product')}>Product</button>
					<button class="v12-tab-btn" class:v12-tab-btn--active={activeTab === 'install'} onclick={() => switchTab('install')}>Install</button>
					<button class="v12-tab-btn" class:v12-tab-btn--active={activeTab === 'maintenance'} onclick={() => switchTab('maintenance')}>Maintenance</button>
				</div>
				...
				<div class="v12-modal-body">
					{#key tabAnimKey}
						{#if activeTab === 'product'}
							<div class="v12-tab-content v12-tab-enter">
								<div class="v12-cross-section">
									<div class="v12-cs-title-row">
										...
										<span class="v12-cs-label">Cross-Section</span>
									</div>
									<div class="v12-cs-diagram">
										{#each layers as layer, li}
											<div class="v12-cs-layer" style="--layer-color: {layer.color}; --layer-h: {layer.height}px; --layer-i: {li};">
												<div class="v12-cs-layer-fill"></div>
												<span class="v12-cs-layer-label">{layer.label}</span>
												<div class="v12-cs-dim-line"><span class="v12-cs-dim-cap"></span><span class="v12-cs-dim-stem"></span><span class="v12-cs-dim-cap"></span></div>
											</div>
										{/each}
									</div>
								</div>
								<div class="v12-tab-text"><p>{openProduct.details || openProduct.blurb}</p></div>
							</div>
						{:else if activeTab === 'install'}
							<div class="v12-tab-content v12-tab-enter">
								<div class="v12-install-visual">
									<div class="v12-install-icon">
										{#if mat === 'carpet-tile'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1.2" fill="none"><rect x="10" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v12-install-tile v12-it-1"/><rect x="55" y="10" width="40" height="40" rx="2" fill="#444446" class="v12-install-tile v12-it-2"/><rect x="100" y="10" width="40" height="40" rx="2" fill="#3a3a3c" class="v12-install-tile v12-it-3"/><rect x="145" y="10" width="40" height="40" rx="2" fill="#444446" class="v12-install-tile v12-it-4"/><rect x="10" y="55" width="40" height="40" rx="2" fill="#444446" class="v12-install-tile v12-it-5"/><rect x="55" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v12-install-tile v12-it-6"/><rect x="100" y="55" width="40" height="40" rx="2" fill="#444446" class="v12-install-tile v12-it-7"/><rect x="145" y="55" width="40" height="40" rx="2" fill="#3a3a3c" class="v12-install-tile v12-it-8"/><rect x="10" y="100" width="40" height="40" rx="2" fill="#3a3a3c" class="v12-install-tile v12-it-9" opacity="0.4" stroke-dasharray="3 2"/></g><path d="M30 135 L30 115" stroke="#d4b87a" stroke-width="1.5" fill="none" marker-end="url(#v12arr)"/><defs><marker id="v12arr" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#d4b87a"/></marker></defs></svg>
										{:else if mat === 'lvt'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1" fill="none"><rect x="10" y="20" width="85" height="26" rx="2" fill="#3e3e40" class="v12-install-plank v12-ip-1"/><rect x="100" y="20" width="85" height="26" rx="2" fill="#444446" class="v12-install-plank v12-ip-2"/><rect x="50" y="50" width="85" height="26" rx="2" fill="#444446" class="v12-install-plank v12-ip-3"/><rect x="140" y="50" width="50" height="26" rx="2" fill="#3e3e40" class="v12-install-plank v12-ip-4"/><rect x="10" y="80" width="85" height="26" rx="2" fill="#3e3e40" class="v12-install-plank v12-ip-5"/><rect x="100" y="80" width="85" height="26" rx="2" fill="#444446" class="v12-install-plank v12-ip-6" opacity="0.5" stroke-dasharray="3 2"/></g><g class="v12-click-indicator"><circle cx="100" cy="65" r="6" stroke="#d4b87a" stroke-width="1.2" fill="none"/><path d="M97 65 L103 65 M100 62 L100 68" stroke="#d4b87a" stroke-width="1"/></g></svg>
										{:else if mat === 'sheet'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1.2" fill="none"><line x1="30" y1="10" x2="30" y2="110" stroke-width="2"/><line x1="30" y1="110" x2="190" y2="110" stroke-width="2"/><path d="M30 100 Q30 90 40 90 L160 90" stroke="#4a4a4c" stroke-width="3" fill="none" class="v12-sheet-unroll"/><path d="M33 40 L33 100 Q33 108 40 108" stroke="#d4b87a" stroke-width="1.5" stroke-dasharray="4 2" class="v12-cove-line"/><circle cx="175" cy="85" r="12" stroke="#4a4a4c" stroke-width="1.5" fill="#2a2a2c" class="v12-roll"/><circle cx="175" cy="85" r="4" stroke="#606062" stroke-width="0.8"/></g><text x="35" y="35" fill="#888" font-size="8" font-family="monospace">WALL</text><text x="100" y="125" fill="#888" font-size="8" font-family="monospace">FLOOR</text></svg>
										{:else if mat === 'hardwood'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1" fill="none"><rect x="10" y="80" width="180" height="16" rx="1" fill="#443e36"/><rect x="10" y="98" width="180" height="12" rx="1" fill="#383430"/><path d="M10 80 L10 96 L190 96 L190 80" stroke="#504a42" stroke-width="0.8"/><line x1="60" y1="45" x2="65" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v12-nail"/><line x1="120" y1="45" x2="125" y2="80" stroke="#d4b87a" stroke-width="1.5" class="v12-nail v12-nail-2"/><rect x="45" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v12-nailer"/><rect x="105" y="20" width="30" height="28" rx="3" fill="#2a2a2c" stroke="#555" class="v12-nailer v12-nailer-2"/></g><text x="42" y="135" fill="#888" font-size="8" font-family="monospace">45deg NAIL THROUGH TONGUE</text></svg>
										{:else if mat === 'rubber'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1" fill="none"><path d="M10 85 Q20 80 30 85 Q40 90 50 85 Q60 80 70 85 Q80 90 90 85 Q100 80 110 85 Q120 90 130 85 Q140 80 150 85 Q160 90 170 85 Q180 80 190 85" stroke="#555" stroke-width="1" class="v12-adhesive"/><rect x="10" y="55" width="55" height="25" rx="2" fill="#3a3a3c" class="v12-rubber-tile v12-rt-1"/><rect x="70" y="55" width="55" height="25" rx="2" fill="#444446" class="v12-rubber-tile v12-rt-2"/><rect x="130" y="40" width="55" height="25" rx="2" fill="#3a3a3c" class="v12-rubber-tile v12-rt-3" opacity="0.6" stroke-dasharray="3 2"/></g><g class="v12-trowel" transform="translate(140,20)"><rect x="0" y="0" width="35" height="6" rx="1" fill="#555"/><rect x="12" y="-10" width="4" height="12" rx="1" fill="#444"/></g></svg>
										{:else if mat === 'ceramic'}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1" fill="none"><rect x="10" y="100" width="180" height="20" rx="1" fill="#2a2a2c"/><rect x="10" y="85" width="180" height="15" rx="1" fill="#383838"/><rect x="12" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v12-ceramic-tile v12-ct-1"/><rect x="58" y="55" width="42" height="28" rx="1" fill="#484848" class="v12-ceramic-tile v12-ct-2"/><rect x="104" y="55" width="42" height="28" rx="1" fill="#3e3e40" class="v12-ceramic-tile v12-ct-3"/><rect x="150" y="45" width="42" height="28" rx="1" fill="#484848" class="v12-ceramic-tile v12-ct-4" opacity="0.5" stroke-dasharray="3 2"/><line x1="56" y1="58" x2="56" y2="80" stroke="#d4b87a" stroke-width="1"/><line x1="102" y1="58" x2="102" y2="80" stroke="#d4b87a" stroke-width="1"/></g><text x="15" y="115" fill="#666" font-size="7" font-family="monospace">SUBSTRATE</text><text x="15" y="97" fill="#777" font-size="7" font-family="monospace">THINSET</text></svg>
										{:else}
											<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1.2" fill="none"><rect x="30" y="40" width="140" height="60" rx="6" fill="#2a2a2c"/><circle cx="100" cy="70" r="20" stroke="#555" stroke-width="1.5"/><path d="M90 70 L97 77 L112 62" stroke="#d4b87a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g><text x="48" y="120" fill="#888" font-size="9" font-family="monospace">CERTIFIED INSTALL</text></svg>
										{/if}
									</div>
									<h3 class="v12-install-method">{install.method}</h3>
								</div>
								<div class="v12-tab-text"><p>{install.desc}</p></div>
							</div>
						{:else if activeTab === 'maintenance'}
							<div class="v12-tab-content v12-tab-enter">
								<div class="v12-maint-visual">
									<div class="v12-maint-icon">
										<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><g stroke="#606062" stroke-width="1.5" fill="none"><path d="M20 45 L25 70 L55 70 L60 45" fill="#2a2a2c"/><ellipse cx="40" cy="45" rx="20" ry="6"/><line x1="40" y1="10" x2="40" y2="38" stroke-width="2"/><rect x="30" y="36" width="20" height="6" rx="2" fill="#3a3a3c"/><g stroke="#d4b87a" stroke-width="1" class="v12-sparkle"><line x1="65" y1="25" x2="65" y2="18"/><line x1="61" y1="22" x2="69" y2="22"/><line x1="15" y1="35" x2="15" y2="28"/><line x1="11" y1="32" x2="19" y2="32"/></g></g></svg>
									</div>
								</div>
								<div class="v12-maint-info">
									<div class="v12-maint-block"><h4>Daily Care</h4><p>{maint.daily}</p></div>
									<div class="v12-maint-block"><h4>Periodic Maintenance</h4><p>{maint.periodic}</p></div>
									<div class="v12-maint-block v12-maint-avoid"><h4>Avoid</h4><p>{maint.avoid}</p></div>
								</div>
							</div>
						{/if}
					{/key}
	...
	<!-- Version nav -->
	<div class="v-nav">
		<a href="/young-carpets">Main</a>
		<a href="/young-carpets/dev/v7">V7</a>
		<a href="/young-carpets/dev/v8">V8</a>
		<a href="/young-carpets/dev/v9">V9</a>
		<a href="/young-carpets/dev/v10">V10</a>
		<a href="/young-carpets/dev/v11">V11</a>
		<span class="v-nav-current">V12</span>
	</div>

	<!-- ===================== FOOTER ===================== -->
	<footer class="v12-footer">
		<div class="yc-container">
			<div class="v12-footer-inner">
				<div class="v12-footer-brand">
					<span class="v12-footer-brand-name">YOUNG</span>
					<span class="v12-footer-brand-sub">Carpets Inc.</span>
				</div>
...
<style>
	...
	:global(.yc-page.v12) {
		...
		--v12-ink: #0b0b0d;
		--v12-text: #c8c8ca;
		--v12-text-muted: rgba(200,200,202,0.5);
		--v12-text-faint: #666;
		--v12-electric: rgba(140, 180, 255, 0.15);
		--v12-electric-hover: rgba(140, 180, 255, 0.25);
		--v12-electric-active: rgba(140, 180, 255, 0.3);
		--v12-electric-ambient: rgba(140, 180, 255, 0.06);
		--v12-electric-glow: rgba(140, 180, 255, 0.12);
		--v12-warm-tint: rgba(255, 240, 220, 0.04);
		--v12-section-py: 80px;
		--v12-section-py-mobile: 60px;
		--v12-container-max: 1100px;
		--v12-card-gap: 16px;
	}

	/* ============================================================
	   GLOBAL OVERRIDES (scoped to .v12)
	   ============================================================ */

	/* 12px radius on pills/badges */
	:global(.yc-page.v12 .yc-section-eyebrow),
	:global(.yc-page.v12 .yc-badge),
	:global(.yc-page.v12 .yc-chip),
	:global(.yc-page.v12 .yc-map-preview-pill),
	:global(.yc-page.v12 .yc-dev-version-badge),
	:global(.yc-page.v12 .yc-stat-number),
	:global(.yc-page.v12 .yc-modal-close),
	:global(.yc-page.v12 .yc-supplier-chip),
	:global(.yc-page.v12 .yc-modal-tab),
	:global(.yc-page.v12 .yc-modal-tab-btn),
	:global(.yc-page.v12 .yc-back-link) {
	...
	:global(.yc-page.v12 .yc-section),
	:global(.yc-page.v12 .yc-map-section) {
		padding-top: var(--v12-section-py, 80px);
		padding-bottom: var(--v12-section-py, 80px);
	}
	@media (max-width: 599px) {
		:global(.yc-page.v12 .yc-section),
		:global(.yc-page.v12 .yc-map-section) {
			padding-top: var(--v12-section-py-mobile, 60px);
			padding-bottom: var(--v12-section-py-mobile, 60px);
		}
	}

	/* Container max-width */
	:global(.yc-page.v12 .yc-container) {
		max-width: var(--v12-container-max, 1100px);
	}

	/* Alternating warm tint on every other section */
	:global(.yc-page.v12 .yc-section--suppliers),
	:global(.yc-page.v12 .yc-section--contact) {
		background: var(--v12-warm-tint, rgba(255, 240, 220, 0.04));
	}

	/* Section titles */
	:global(.yc-page.v12 .yc-section-title) {
		font-size: 1.6rem;
		letter-spacing: 0.06em;
		line-height: 1.2;
	}

	/* Eyebrow — greyscale, not gold */
	:global(.yc-page.v12 .yc-section-eyebrow) {
		color: var(--v12-text-muted, rgba(200,200,202,0.5));
	}
	...
	.v12-nav-section {
		...
		color: var(--v12-text-muted, rgba(200,200,202,0.6));
		margin-left: 0.75rem;
		white-space: nowrap;
		overflow: hidden;
		text-overflow: ellipsis;
		opacity: 0;
		animation: v12-fade-in 300ms ease forwards;
	}
	@keyframes v12-fade-in {
	...
	.v12-hamburger-bar.open:nth-child(1) { transform: rotate(45deg) translate(5px, 5px); }
	.v12-hamburger-bar.open:nth-child(2) { opacity: 0; }
	.v12-hamburger-bar.open:nth-child(3) { transform: rotate(-45deg) translate(5px, -5px); }
	.v12-mobile-menu {
		width: 100%;
		display: flex;
		flex-direction: column;
	...
	.v12-mobile-menu button {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.7rem;
		font-weight: 700;
		letter-spacing: 0.08em;
		text-transform: uppercase;
		color: var(--v12-text-muted, rgba(200,200,200,0.6));
		background: transparent;
		border: none;
	...
	.v12-mobile-menu button:hover {
		color: var(--yc-text, #e6e6e8);
		background: var(--v12-electric-ambient, rgba(140, 180, 255, 0.06));
	}
	...
	.v12-hero-maple .yc-maple-leaf {
		width: 48px;
		height: 48px;
		color: var(--yc-maple-gold, #d4b87a);
		opacity: 0.7;
	}
	.v12-hero-maple::after {
		content: '';
		position: absolute;
		inset: -20px;
		border-radius: 50%;
	...
	.yc-hero.alive .v12-hero-maple::after {
		opacity: 1;
	}
	.v12-hero-tag {
		font-family: ui-monospace, 'SF Mono', monospace;
	...
	.v12-wordmark--ready { visibility: visible; }
	.v12-wordmark__char {
		display: inline-block;
		opacity: 0;
		transform: translateY(28px) scale(0.92);
	}
	.v12-wordmark--ready .v12-wordmark__char {
		animation: v12-letter-in 700ms cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
		animation-delay: calc(var(--young-i, 0) * 80ms);
		will-change: transform, opacity;
	}
	@keyframes v12-letter-in {
	...
	.v12-cta-primary:hover {
		border-color: var(--v12-electric-hover, rgba(140,180,255,0.25));
		box-shadow: 0 2px 12px var(--v12-electric, rgba(140,180,255,0.15));
	...
	.yc-hero.alive .v12-hero-stats {
		animation: v12-stats-pulse 1s ease-out 800ms;
		opacity: 1;
	}
	@keyframes v12-stats-pulse {
		0% { opacity: 0.7; filter: brightness(1); }
		40% { filter: brightness(1.15); }
		100% { opacity: 1; filter: brightness(1); }
	}
	@media (max-width: 380px) {
		.v12-hero-stats { flex-direction: column; gap: 1rem; }
	}
	.v12-stat {
		display: flex;
		flex-direction: column;
	...
	/* ============================================================
	   PRODUCTS
	   ============================================================ */
	:global(.yc-page.v12 .yc-products-grid) { gap: var(--v12-card-gap, 16px); }
	@media (max-width: 599px) {
		:global(.yc-page.v12 .yc-products-grid) { grid-template-columns: 1fr; }
	}
	@media (min-width: 600px) and (max-width: 899px) {
		:global(.yc-page.v12 .yc-products-grid) { grid-template-columns: repeat(2, 1fr); }
	}
	@media (min-width: 900px) {
		:global(.yc-page.v12 .yc-products-grid) { grid-template-columns: repeat(3, 1fr); }
	}

	/* Product card blurb clamp */
	:global(.yc-page.v12 .yc-product-blurb) {
		overflow: hidden;
		display: -webkit-box;
		-webkit-line-clamp: 3;
		line-clamp: 3;
	...
	.v12-services-grid {
		...
		gap: var(--v12-card-gap, 16px);
	}
	@media (min-width: 600px) {
		.v12-services-grid { grid-template-columns: repeat(3, 1fr); }
	}

	/* ============================================================
	   MAP — Bigger
	   ============================================================ */
	:global(.yc-page.v12 .yc-map-preview) {
		max-width: 600px !important;
		aspect-ratio: 4 / 3 !important;
	}
	@media (min-width: 900px) {
		:global(.yc-page.v12 .yc-map-preview) { max-width: 720px !important; }
	}
	...
	@media (min-width: 600px) {
		.v12-contact-grid { grid-template-columns: 1fr 1fr; }
	}
	.v12-contact-people {
		display: grid;
		grid-template-columns: 1fr;
	...
	@media (min-width: 420px) {
		.v12-contact-people { grid-template-columns: repeat(2, 1fr); }
	}
	@media (min-width: 600px) {
		.v12-contact-people { grid-template-columns: repeat(3, 1fr); }
	}
	.v12-person-card {
	...
	.v12-person-card a:hover { color: var(--yc-text, #e6e6e8); }
	.v12-contact-side {
		display: flex;
		flex-direction: column;
		gap: 1rem;
	...
	.v12-contact-card .v12-person-card {
		background: transparent;
		border: none;
	...
	.v12-contact-card .v12-person-card:last-child { border-bottom: none; }
	...
	.v12-footer-brand { display: flex; flex-direction: column; gap: 0.1rem; }
	.v12-footer-brand-name {
		font-family: 'Square721', ui-serif, Georgia, serif;
		font-size: 1.2rem;
		font-weight: 400;
	...
	.v12-footer-info a:hover { color: var(--yc-text, #e6e6e8); }

	/* ============================================================
	   PRODUCT MODAL — Glass + Tabs + Rich Content
	   ============================================================ */
	.v12-modal-backdrop {
		position: fixed;
		inset: 0;
		...
		justify-content: center;
		padding: 1rem;
		animation: v12-backdrop-in 200ms ease;
	}
	@keyframes v12-backdrop-in { from { opacity: 0; } to { opacity: 1; } }
	...
	.v12-modal {
		...
		border-radius: 20px;
		padding: 1.5rem;
		animation: v12-modal-in 300ms cubic-bezier(0.34, 1.56, 0.64, 1);
	}
	@media (max-width: 599px) {
		.v12-modal {
			max-width: 100%;
		...
		.v12-modal-backdrop { padding: 0; }
	}
	@keyframes v12-modal-in {
	...
	.v12-modal-close:hover { background: rgba(255,255,255,0.12); }

	.v12-modal-header { margin-bottom: 1rem; }
	.v12-modal-code {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.7rem;
		font-weight: 700;
	...
	.v12-tab-btn {
		...
		background: transparent;
		color: var(--v12-text-muted, rgba(200,200,200,0.5));
		cursor: pointer;
	...
	.v12-tab-enter { animation: v12-tab-slide 300ms ease-out; }
	@keyframes v12-tab-slide {
		from { opacity: 0; transform: translateY(8px); }
		to { opacity: 1; transform: translateY(0); }
	}
	.v12-tab-text { margin-top: 1rem; }
	.v12-tab-text p {
		font-size: 0.875rem;
		line-height: 1.7;
		color: var(--v12-text, #c8c8ca);
	...
	.v12-cs-diagram { display: flex; flex-direction: column; gap: 0; }
	.v12-cs-layer {
		display: flex;
		align-items: center;
		gap: 0.75rem;
		...
		position: relative;
		animation: v12-layer-slide 400ms ease-out backwards;
		animation-delay: calc(var(--layer-i, 0) * 80ms);
	}
	@keyframes v12-layer-slide {
	...
	.v12-cs-layer:hover .v12-cs-layer-fill {
	...
	.v12-cs-dim-cap { width: 6px; height: 1px; background: rgba(200,200,200,0.25); }
	.v12-cs-dim-stem { flex: 1; width: 1px; background: rgba(200,200,200,0.15); }
	...
	.v12-install-icon { width: 100%; max-width: 300px; }
	.v12-install-icon svg { width: 100%; height: auto; }
	.v12-install-method {
		font-family: ui-monospace, 'SF Mono', monospace;
		font-size: 0.75rem;
		font-weight: 700;
	...
	/* Install animations */
	.v12-install-tile { animation: v12-tile-place 400ms ease-out backwards; }
	.v12-it-1 { animation-delay: 0ms; }  .v12-it-2 { animation-delay: 60ms; }
	.v12-it-3 { animation-delay: 120ms; } .v12-it-4 { animation-delay: 180ms; }
	.v12-it-5 { animation-delay: 240ms; } .v12-it-6 { animation-delay: 300ms; }
	.v12-it-7 { animation-delay: 360ms; } .v12-it-8 { animation-delay: 420ms; }
	.v12-it-9 { animation-delay: 480ms; }
	@keyframes v12-tile-place {
		from { opacity: 0; transform: translateY(-8px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v12-install-plank { animation: v12-plank-snap 350ms ease-out backwards; }
	.v12-ip-1 { animation-delay: 0ms; }  .v12-ip-2 { animation-delay: 80ms; }
	.v12-ip-3 { animation-delay: 160ms; } .v12-ip-4 { animation-delay: 240ms; }
	.v12-ip-5 { animation-delay: 320ms; } .v12-ip-6 { animation-delay: 400ms; }
	@keyframes v12-plank-snap {
		from { opacity: 0; transform: translateX(12px); }
		to { opacity: 1; transform: translateX(0); }
	}

	.v12-click-indicator { animation: v12-click-pulse 1.5s ease-in-out infinite; }
	@keyframes v12-click-pulse { 0%, 100% { opacity: 0.5; } 50% { opacity: 1; } }

	.v12-ceramic-tile { animation: v12-tile-drop 400ms ease-out backwards; }
	.v12-ct-1 { animation-delay: 0ms; }  .v12-ct-2 { animation-delay: 100ms; }
	.v12-ct-3 { animation-delay: 200ms; } .v12-ct-4 { animation-delay: 300ms; }
	@keyframes v12-tile-drop {
		from { opacity: 0; transform: translateY(-12px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v12-rubber-tile { animation: v12-rubber-place 400ms ease-out backwards; }
	.v12-rt-1 { animation-delay: 0ms; }  .v12-rt-2 { animation-delay: 120ms; }
	.v12-rt-3 { animation-delay: 240ms; }
	@keyframes v12-rubber-place {
		from { opacity: 0; transform: translateY(-6px); }
		to { opacity: 1; transform: translateY(0); }
	}

	.v12-nail { animation: v12-nail-drive 500ms ease-out backwards; animation-delay: 200ms; }
	.v12-nail-2 { animation-delay: 500ms; }
	@keyframes v12-nail-drive {
	...
	.v12-sheet-unroll {
		...
		animation: v12-unroll 800ms ease-out forwards; animation-delay: 200ms;
	}
	@keyframes v12-unroll { to { stroke-dashoffset: 0; } }

	.v12-cove-line {
		stroke-dasharray: 100; stroke-dashoffset: 100;
		animation: v12-cove-draw 600ms ease-out forwards; animation-delay: 400ms;
	}
	@keyframes v12-cove-draw { to { stroke-dashoffset: 0; } }
	...
	.v12-maint-icon { width: 80px; height: 80px; }
	.v12-maint-icon svg { width: 100%; height: 100%; }
	.v12-sparkle { animation: v12-sparkle-pulse 2s ease-in-out infinite; }
	@keyframes v12-sparkle-pulse { 0%, 100% { opacity: 0.4; } 50% { opacity: 1; } }
	.v12-maint-info { display: flex; flex-direction: column; gap: 0.75rem; margin-top: 1rem; }
	.v12-maint-block {
		padding: 0.75rem;
	...
	.v12-maint-avoid h4 { color: #c86060; }

	/* ============================================================
	   "COME ALIVE" — Subtle scroll-activated effects (V11 calibration)
	   ============================================================ */

	/* Hero alive (on load) */
	.yc-hero { opacity: 0.85; transition: opacity 800ms ease-out; }
	.yc-hero.alive { opacity: 1; }

	/* Products section alive */
	:global(.yc-page.v12 .yc-section--products .yc-product-card) {
		opacity: 0.85;
		transition: opacity 600ms ease-out, box-shadow 200ms ease, transform 200ms ease;
		will-change: opacity, box-shadow, transform;
	}
	:global(.yc-page.v12 .yc-section--products.alive .yc-product-card) {
		opacity: 1;
		box-shadow: 0 1px 4px rgba(140,180,255,0.03);
	}

	/* Services section alive */
	:global(.yc-page.v12 .yc-section--services .yc-card) {
		opacity: 0.85;
		filter: brightness(0.92);
		transition: opacity 600ms ease-out, filter 600ms ease-out, transform 200ms ease, box-shadow 200ms ease;
		will-change: opacity, filter;
	}
	:global(.yc-page.v12 .yc-section--services.alive .yc-card) {
		opacity: 1;
		filter: brightness(1);
	}

	/* Map section alive */
	:global(.yc-page.v12 .yc-map-section .yc-map-preview-iframe) {
		filter: brightness(0.7);
		transition: filter 600ms ease-out;
	}
	:global(.yc-page.v12 .yc-map-section.alive .yc-map-preview-iframe) {
		filter: brightness(1);
	}

	/* Contact section alive */
	:global(.yc-page.v12 .yc-section--contact) { position: relative; }
	:global(.yc-page.v12 .yc-section--contact.alive) .v12-person-card {
		opacity: 1;
		animation: v12-contact-pulse 1.5s ease-in-out;
	}
	@keyframes v12-contact-pulse {
	...
	/* Suppliers alive */
	:global(.yc-page.v12 .yc-section--suppliers) { opacity: 0.85; transition: opacity 600ms ease-out; }
	:global(.yc-page.v12 .yc-section--suppliers.alive) { opacity: 1; }
</style>
