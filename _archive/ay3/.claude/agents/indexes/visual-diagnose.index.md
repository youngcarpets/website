...
| Path | Purpose |
|------|---------|
| `C:/DEV/ay3/forClaude/` | Primary drop zone — user-provided screenshots, mockups, photos, font files, references |
| `C:/DEV/ay3/docs/screenshots/` | Docs-bundled screenshots (if any) |
| `C:/DEV/ay3/.claude/reference/` | Reference imagery committed to the repo |
| `C:/DEV/ay3/my-portal/static/` | Static assets that might themselves be the subject of the question |
