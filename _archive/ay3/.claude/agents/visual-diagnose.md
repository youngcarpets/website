...
1. `C:/DEV/ay3/forClaude/` — primary drop zone for user-provided screenshots and references
2. `C:/DEV/ay3/docs/screenshots/` — any docs-bundled screenshots
3. `C:/DEV/ay3/.claude/reference/` — reference imagery committed to the repo
4. `C:/DEV/ay3/my-portal/static/` — any static assets that might be the subject of the visual question
