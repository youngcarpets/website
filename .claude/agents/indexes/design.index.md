...
| File | Purpose |
|------|---------|
| `src/routes/+layout.svelte` | Glass nav, footer, site-wide styles, design tokens |
| `src/routes/+page.svelte` | Hero with YOUNG wordmark, Square721 font |
| `src/app.html` | Font preloads, favicon links |
| `CLAUDE.md` | Design Tokens section — authoritative token values |

## Design Tokens Quick Ref
- Body font: `'Inter Variable', system-ui, sans-serif`
- Brand font: `'Square721Nav'` (wordmark + favicon only)
- Glass: `rgba(18, 18, 21, 0.55)` + `blur(24px) saturate(1.8)`
- Border: `1px solid rgba(255, 255, 255, 0.1)`
- Hover glow: `rgba(212, 184, 122, 0.08)`, accent `#d4b87a`
- Radii: 16px (large), 8px (small)
- Body bg: `#0b0b0d`, text: `#e6e6e8`
- Spacing: 4px grid
